...
# Import your Custom Dataloader (ensure this matches your file structure)
...
def main():
    ...
    # Dynamically set channel count based on encoding method
    ...
    ################################################################################
    # Validation
    ms_swd = MSSWD(n_levels=3, n_descriptors=512, descriptor_size=(3, 7, 7),
                   n_repeat=12, n_proj=128, padding_mode='circular',
                   combine_levels=True, 
    ...
    for i in range(num_training):
        output_label = f'fluvgan_1_training_1_{model_name}_{i + 1}'
        ...
        if checkpoint_paths:
            ...
            # Include an indicator in the filename if one-hot encoding was disabled
            encoding_tag = "no_onehot" if not use_one_hot else "onehot"
