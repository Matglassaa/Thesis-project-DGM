"""
This script summarizes and visualizes the datasets generated by FLUMY and the eventual realization geneerated by the GAN. 
...
from scripts.custom_plots import apply_custom_plotting_flavor
